...
export const cruises: Cruise[] = [
  ...
  // ===== 3. MV Jol Safari =====
  {
    id: "mv-jol-safari",
    name: "এমভি জল সাফারি",
    subtitle: "এসি পর্যটকবাহী ক্রুজ জাহাজ — সুন্দরবন",
    description: "এমভি জল সাফারি একটি আধুনিক এসি পর্যটকবাহী জাহাজ, যা সুন্দরবনের ম্যানগ্রোভ অরণ্যে ভ্রমণের জন্য নির্মিত। আপনার বিনোদন ও অ্যাডভেঞ্চারের প্রয়োজন মাথায় রেখে এতে তৈরি করা হয়েছে বন্ধ ও প্রশস্ত ওপেন-এয়ার অবজারভেশন ডেক।",
    route: "খুলনা → সুন্দরবন → খুলনা",
    duration: "৩ দিন / ২ রাত",
    capacity: "৪০ জন",
    cabins: "১৫টি",
    ...
    itinerary: [
      {
        ...
        title: "খুলনা থেকে আন্দারমানিক",
        activities: [
          "সকাল ৭:০০ টায় খুলনা জেলখানা ঘাট থেকে গাইড দ্বারা স্বাগত এবং শীপে নিয়ে যাওয়া।",
          "রুপসা এবং পশুর নদী ধরে খুলনা শিপইয়ার্ড, রুপসা ব্রিজ, রামপাল তাপ বিদ্যুৎ কেন্দ্র এবং মংলা বন্দর পাশ দিয়ে আন্দারমানিক অভিমুখে যাত্রা।",
          "দুপুরের খাবার খেয়ে আন্দারমানিক ইকো-ট্যুরিজম কেন্দ্রে নামা।",
          "গানম্যান সহ নির্ধারিত ফুট ট্রেইল ধরে হাঁটা।",
          "মিষ্টি পানির পুকুর পার হয়ে গভীর বনে প্রবেশ।",
          "সুন্দরী, গোলপাতা ও গেওয়া গাছ পর্যবেক্ষণ।",
          "প্রায় ১ মাইল ট্রেইল ঘুরে ওয়াচ টাওয়ারে বিশ্রাম।",
          "শীপে ফিরে বিকালের নাস্তা।",
          "কটকা অভয়ারণ্যের উদ্দেশ্যে যাত্রা।",
        ],
      },
      {
        day: "📅 ২য় দিন",
        title: "কটকা এবং কচিখালি অভিযান",
        activities: [
          "খুব সকালে দেশি নৌকায় ক্যানেল ক্রুজিং এবং বনের নিস্তব্ধতা উপভোগ।",
          "টাইগার ট্রি'র ঝোপ এবং হরিণের বিচরণের মাঠ পেরিয়ে জামতলা সী বিচে যাওয়া।",
          "সুন্দরবন এবং বঙ্গোপসাগরের মিলনস্থল দেখা।",
          "কটকা অফিস পাড়ায় যাওয়া এবং হরিণের পাল দেখা।",
          "কচিখালির ছন বনের ভিতর দিয়ে হাঁটা।",
          "বাঘের ডাইনিং হিসেবে পরিচিত এলাকা অন্বেষণ।",
          "শীপে ফিরে ডিমের চরে যাওয়া।",
          "সুন্দর সী বিচে সন্ধ্যা পর্যন্ত সময় কাটানো।",
          "করমজলের উদ্দেশ্যে যাত্রা।",
        ],
      },
      {
        day: "📅 ৩য় দিন",
        title: "করমজল এবং প্রত্যাবর্তন",
        activities: [
          "করমজলে বাংলাদেশের একমাত্র নোনা পানির কুমির প্রজনন কেন্দ্র পরিদর্শন।",
          "ছোট বড় কুমির দেখা।",
          "বিলুপ্তপ্রায় প্রজাতির কচ্ছপ পর্যবেক্ষণ।",
          "বানরের পালের দুষ্টুমি দেখা।",
          "হরিণকে হাত থেকে ঘাস খাওয়ানোর অভিজ্ঞতা।",
          "শীপে ফিরে খুলনা / মংলার উদ্দেশ্যে যাত্রা।",
        ],
      },
    ],
    menu: [
      { day: "১ম দিন", items: "সকালের নাস্তা: পাউরুটি, পরোটা, সবজি, ডাল, ডিম অমলেট, মাখন, জেলি, মধু, কলা, ডেজার্ট (সুজি / পায়েস), চা-কফি। স্ন্যাকস: কেক, বিস্কুট, চা-কফি। দুপুরের খাবার: সাদা ভাত, পারশে মাছ, মুরগি, ভর্তা, ডাল, সালাদ, ডেজার্ট, চা-কফি। বিকেলের স্ন্যাকস: থাই স্যুপ, ফ্রেঞ্চ ফ্রাই, চা-কফি। রাতের খাবার: এগ ফ্রাইড রাইস, চিকেন ফ্রাই, চাইনিজ সবজি, চিংড়ি মালাইকারি, কাজুবাদাম সালাদ, সফট ড্রিংকস।" },
      { day: "২য় দিন", items: "মর্নিং স্ন্যাকস: ড্রাই কেক / বিস্কুট, চা-কফি। সকালের নাস্তা: খিচুড়ি, ডিম মালাইকারি, সামুদ্রিক মাছ ভাজা, বেগুন ভাজা, আচার, চা-কফি। স্ন্যাকস: পেয়ারা, লেবুর শরবত, চা-কফি। দুপুরের খাবার: সাদা ভাত, কোরাল মাছ, হাঁস ভুনা, সবজি, ভর্তা, ডাল, সালাদ, ফিরনি, চা-কফি। স্ন্যাকস: নুডলস, চা-কফি। রাতের খাবার: এগ ফ্রাইড রাইস, পরোটা, চিকেন বারবিকিউ, ফিশ বারবিকিউ, চাইনিজ সবজি, ছোলার ডাল ভুনা, রাশিয়ান সালাদ, সফট ড্রিংকস।" },
      { day: "৩য় দিন", items: "সকালের নাস্তা: সাদা ভাত, বিভিন্ন ভর্তা, ডিম অমলেট, ঘি, ডাল, সালাদ, চা-কফি। স্ন্যাকস: কমলা, বিস্কুট, চা-কফি। দুপুরের খাবার: প্লেইন পোলাও, মাটন রেজালা, সি-ফিশ, ডিম মালাইকারি, মুরিঘন্ট, সালাদ, দই।" },
    ],
    safetyInfo: [
      "নিরাপত্তার ব্যাপারে কোনো আপোস নেই।",
      "বাংলাদেশ বনবিভাগের দুইজন সশস্ত্র নিরাপত্তা কর্মী সার্বক্ষণিক নিয়োজিত।",
      "VSF এর মাধ্যমে ফরেস্ট বিভাগ, কোস্ট গার্ড এবং নৌবাহিনীর সাথে সার্বক্ষণিক যোগাযোগ।",
      "জরুরি পরিস্থিতিতে তাৎক্ষণিক সহায়তা ব্যবস্থা।",
    ],
    travelTips: [
      "উজ্জ্বল রঙের কাপড় পরিহার করুন",
      "হালকা রঙের ঢিলেঢালা ফুল স্লিভ পোশাক পরুন",
    ...
    additionalCosts: [
      "বিদেশি নাগরিকদের প্রবেশ ফি: ১০,৫০০ টাকা",
      "বাংলাদেশি নাগরিকদের প্রবেশ ফি: ১,০৫০ টাকা",
    ],
    packageIncludes: [
      "ট্রিপ চলাকালীন সকল খাবার।",
      "ভ্রমণসূচি অনুযায়ী বনের ভিতরে সকল কার্যক্রম।",
  ...
  // ===== 4. MV Magpie =====
  {
    ...
    description: "MV Magpie is a modern cruise ship with excellent facilities and spacious accommodation. Named after the beautiful Magpie bird, it brings you closer to nature in the Sundarbans.",
    ...
    facilities: [
      "Large Conference Room", "Open Air Deck", "Decorated Dining",
  ...
  // ===== 5. MV Pearl =====
  {
    ...
    name: "M.V Pearl",
    subtitle: "Tourist Ship — Mangrove Forest Sundarban",
    description: "MV Pearl is a premium cruise offering a luxurious journey through the Sundarbans with top-class amenities, spacious cabins, and breathtaking views of the mangrove forest.",
    route: "Khulna → Sundarban → Khulna",
    duration: "3 Days / 2 Nights",
    ...
    facilities: [
      "Large Conference & Prayer Room", "Spacious Open Air Observation Deck", "Decorated Rooftop Dining",
      "VHF & GPS Navigation", "Projector & Sound System", "Modern Toilets",
      "Generator", "Life Jackets and Life Buoys", "Fire Extinguisher Systems",
    ],
    touristSpots: commonTouristSpots,
    ...
    seatPlan: [
      {
        name: "Ground Floor",
        capacity: 24,
        rows: [{ label: "AC Cabins", cabins: Array.from({ length: 12 }, (_, i) => ({ id: `G${i + 1}`, type: "Twin" as const, bedType: "Twin Bed AC", persons: 2, available: true })) }],
      },
      {
        name: "1st Floor",
        capacity: 30,
